...
class IPC:
   def check(self,n):
     d2={'112':['If an act which causes harm to be done in consequence of the abetment.', 'Imprisonment for 14 Years and fine.', 'According as offence abetted is cognizable or non-cognizable', 'Non-bailable.', 'Court by which offence is triable.'],
     '115':['If an act which causes harm be done in consequence of the abetment.', 'Imprisonment for 14 years and fine.', 'According as offence abetted is cognizable or non-cognizable.', 'Non-bailable.', 'Court by which offence abetted is triable.'],
     ...
     '123A':['Promoting enmity between classes in place of worship, etc.', 'Imprisonment for 5 years, and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '123B':['If committed in a place of public worship, etc.', 'Imprisonment for 5 years and fine', 'Cognizable', 'Non-Bailable', 'Magistrate of the first class.'],
     ...
     '172':['If summons or notice require attendance in person, etc., in a Court of Justice.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both. ', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '173':['If summons, etc., require attendance in person, etc., in a Court of Justice.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '174':['If the order requires personal attendance, etc., in a Court of Justice.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '175':['If the document is required to be produced in or delivered to a Court of Justice.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed, subject to the provisions of Chapter XXVI; or, if not committed, in a court, any Magistrate.'],
     '176':['If the notice or information required respects the commission of an offence, etc.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'], 
     ...
     '187':['Wilfully neglecting to aid a public servant who demands aid in the execution of process, the prevention of offences, etc.', 'S.I for 6 months, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '188':['If such disobedience causes danger to human life, health or safety, etc.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '225A':['(b) in case of negligent omission or sufferance.', 'S.I for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '228A':['Printing or publication of a proceeding without prior permission of court.', 'Imprisonment for 2 years and fine.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '235':['If Indian coin.', 'Imprisonment for 10 years and fine.', 'Cognizable', 'Non-Bailable', 'Court of Sessions.'],
     '294A':['Publishing proposals relating to lotteries.', 'Fine of Rs. 1,000/-', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '474':['If the document is one of the description mentioned in section 467 of the I.P.C.', 'Imprisonment for life, or imprisonment for 7 years and fine.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '500':['Defamation in any other case', 'S.I for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '501':['(b) Printing or engraving matter knowing it to be defamatory, in any other case.', 'S.I for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '502':['(b) Sale of printed or engraved substance containing defamatory matter, knowing it to contain such matter in any other case.', 'S.I for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     d3={'119':['If the offence be not committed.', 'Imprisonment extending to a quarter part of the longest term provided for the offence, or fine, or both.', 'According as offence abetted is Cognizable or Non-Cognizable', 'Bailable.', 'Court by which offence abetted is triable.'],
     '176':['If the notice or information is required by an order passed under sub-section (1) of section 356 of this Code.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.','Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '222':['If under sentence of imprisonment for less than 10 years or lawfully committed to custody.', 'Imprisonment for 3 years, or fine, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '307':['Attempt by life-convict to muder, if hurt is caused.', 'Death or imprisonment for 10 years and fine.', 'Cognizable.', 'Non-bailable.', 'Court of Session.'],
     ...
     '115':['Abetment of an offence, punishable with death or imprisonment for life, if the offence be not committed in consequence of the abetment.', 'Imprisonment for 7 years and fine.', 'According as offence abetted is cognizable or non-cognizable.', 'Non-bailabale', 'Court by which offence abetted is triable.'],
     '112':['Abetment of an offence, punishable with  death or imprisonment for life, if the offence be not committed in Consequence of the abetment', 'Imprisonment for 7 Years and fine.', 'According as offence abetted is cognizable or non-connizable', 'Non-bailable.', 'Court by which offence is triable.'],      
     ...
     '129':['Public servant negligently suffering prisoner of State or war in his custody to escape.', 'S.I for 3 years and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '137':['Deserter concealed on board merchant vessel, through negligence of master or person in charge thereof.', 'Fine of Rs.500/-.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '140':['Wearing the dress or carrying any token used by a soldier, sailor or airman with intent that it may be believed that he is such a soldier, sailor or airman.', 'Imprisonment for 3 months, or fine of Rs. 500/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '153AA':['Knowingly carrying arms in any procession or organising or holding or taking part in any mass drill or mass traning with arms.', 'Imprisonment for 6 months and kfine of Rs. 2,000/-.', 'Cognizable', 'Non-Bailable', 'Any Magistrate.', 'Ins. by Cr.P.C (Amendment) Act 2005 (25 of 2005)'],
     ...
     '154':['Owner or occupier of land not giving information of riot, etc.', 'Fine of Rs. 1,000/-.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '160':['Committing affray.', 'Imprisonment for one month, or fine of Rs. 100/- or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     
     '161':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).','','','',''],
     '162':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).','','','',''],
     '163':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).','','','',''],
     '164':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).','','','',''],
     '165':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).','','','',''],
     '165A':['Sections 161 to 165A of the I.P.C 1860 (45 of 1860) repealed by the Prevention of Corruption Act. 1988 (49 of 1988).', '', '', '', ''],
     '166':['Public servant disobeying a direction of the law with intent to cause injury to any person.', 'S.I for 1 year, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '168':['Public servant unlawfully engaging in trade.', 'S.I for 1 year, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '169':['Public servant unlawfully buying or bidding for property.', 'S.I for 2 years, or fine, or both and confiscation of property, if purchased.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '170':['Personating a public servant.', 'Imprisonment for 2 years or fine, or both .', 'Cognizable', 'Non-Bailable', 'Any Magistrate.'],
     '171':['Wearing garb or carrying token used by public servant with fraudulent intent.', 'Imprisonment for 3 months, or fine of Rs. 200/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '171H':['Illegal payments in connection with elections.', 'Fine of Rs. 500/-.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '171I':['Failure to keep election accounts.', 'Fine of Rs. 500/-.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],

     '172':['Absconding to avoid service of summons or other proceeding from a public servant.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '173':['Preventing the service or the affixing of any summons of notice, or the removal of it when it has been affixed, or preventing a proclamation.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '174':['Not obeying a legal order to attend at a certain place in person or by agent, or departing therefrom without authority.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '175':['Intentionally omitting to produce a document to a public servant by a person legally bound to produce or deliver such document.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed, subject to the provisions of Chapter XXVI; or, if not committed, in a court, any Magistrate.'],
     '176':['Intentionally omitting to give notice or information to a public servant by a person legally bound to give such notice or information.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '177':['Knowingly furnishing false information to a public servant.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.','Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '178':['Refusing oath when duly required to take oath by a public servant.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed, subject to the provisions of Chapter XXVI; or, if not committed in a Court, any Magistrate.'],
     '179':['Being legally bound to state truth, and refusing to answer questions.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed, subject to the provisions of Chapter XXVI; or, if not committed in a Court, any Magistrate.'],
     '180':['Refusing to sign a statement made to a public servant when legally required to do so.', 'S.I for 3 months, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed, subject to the provisions of Chapter XXVI; or, if not committed in a Court, any Magistrate.'],
     ...
     '182':['Giving false information to a public servant in order to cause him to use his lawful power to the injury or annoyance of any person.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '183':['Resistance to the taking of property by the lawful authority of a public servant.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '184':['Obstructing sale of property offered for sale by authority of a public servant.', 'Imprisonment for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '185':['Bidding, by a person under a legal incapacity to purchase it, for property at a lawfully authorised sale, or bidding without intending to perform the obligations incurred thereby.', 'Imprisonment for 1 month, or fine of Rs. 200/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '186':['Obstructing public servant in discharge of his public functions.', 'Imprisonment for 3 months, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '187':['Omission to assist public servant when bound by law to give such assistance.', 'S.I for 1 month, or fine of Rs. 200/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '188':['Disobedience to an order lawfully promulgated by a public servant, if such disobedience causes obstruction, annoyance or injury to persons lawfully employed.', 'S.I for 1 month, or fine of Rs. 200/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '197':['Knowingly issuing or signing a false certificate relating to any fact of which such certificate is by law admissible in evidence.', 'The same as for giving or fabricating false evidence.', 'Non-Cognizable', 'Bailable', 'Court by which offence of giving false evidence is triable.'],
     '198':['Using as a true certificate one known to be false in a material point.', 'The same as for giving or fabricating false evidence.', 'Non-Cognizable', 'Bailable', 'Court by which offence of giving false evidence is triable.'],
     '199':['False statement made in any declaration which is by law receivable as evidence. ', 'The same as for giving or fabricating false evidence.', 'Non-Cognizable', 'Bailable', 'Court by which offence of giving false evidence is triable.'],
     ...
     '223':['Escape from confinement negligently suffered by a public servant.', 'S.I for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '228':['Intentional insult or interruption to a public servant sitting in any stage of a judicial proceeding.', 'S.I for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'The Court in which the offence is committed subject to the provisions of Chapter XXVI.'],
     '228A':['Disclosure of identity of the victim of certain offences, etc.', 'Imprisonment for 2 years and fine.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '263A':['Fictitious stamps', 'Fine of Rs. 200/-', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '272':['Adulterating food or drink intended for sale, so as to make the same noxious.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '273':['Selling any food or drink as food and drink, knowing the same to be noxious.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '274':['Adulterating any drug or medical preparation intended for sale so as to lessen its efficacy, or to change its operation, or to make it noxious.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both', 'Non-Cognizable', 'Non-Bailable', 'Any Magistrate.'],
     '275':['Offering for sale or issuing from a dispensary any drug or medical preparation known to have been adulterated.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '276':['Knowingly selling or issuing from a dispensary any drug or medical preparation as a different drug or medical preparation.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '277':['Defiling the water of a public spring or reservoir.', 'Imprisonment for 3 months, or fine of Rs. 500/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '278':['Making atmosphere noxious to health.', 'Fine of Rs. 500/-', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '279':['Driving or riding on a public way so rashly or negligently as to endanger human life, etc.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '280':['Navigating any vessel so rashly or negligently as to endanger human life, etc.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '282':['Conveying for hire any person by water, in a vessel in such a state, or so loaded, as to endanger his life.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '283':['Causing danger, obstruction or, injury in any public way or line of navigation.', 'Fine of Rs. 200/-.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '284':['Dealing with any poisonous substance so as to endanger human life, etc.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '285':['Dealing with fire or any combustible matter so as to endanger human life, etc.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '286':['So dealing with any explosive substance.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '287':['So dealing with any machinery.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '288':['A person omitting to guard against probable danger to human life by the fall of any building over which he has a right entitling him to pull it down or repair it.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '289':['A person omitting to take order with any animal in his possession, so as to guard against danger to human life, or of grievous hurt, from such animal.', 'Imprisonment for 6 months, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '290':['Committing a public nuisance', 'Fine of Rs. 200/-', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '291':['Continuance of nuisance after injunction to discontinue.', 'S.I for 6 months, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '292':['Sale, etc., of obscene books, etc.', 'On first conviction, with imprisonment for 2 years, and with fine of Rs. 2,000/-, and, in the event of second or subsequent conviction, with imprisonment for 5 years, and with fine of Rs. 5,000/-.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '293':['Sale, etc., of obscene objects to young persons.', 'On first conviction, with imprisonment for 3 years, and with fine of Rs. 2,000/-, and in the event of second or subsequent conviction, with imprisonment for 7 years, and with fine of Rs. 5,000/-.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '309':['Attempt to commit suicide.', 'S.I for 1 year, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '323':['Voluntarily causing hurt.', 'Imprisonment for 1 year or fine of Rs. 1,000/, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '324':['Voluntarily causing hurt by dangerous weapons or means.', 'Imprisonment for 3 years, or fine, or both.', 'Cognizable', 'Non-Bailable', 'Any Magistrate.'], 
     ...
     '334':['Voluntarily causing hurt on grave and sudden provocation, not intending to hurt any other than the person who gave the provocation.', 'Imprisonment for 1 month, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '335':['Causing grievous hurt on grave and sudden provocation, not intending to hurt any other than the person who gave the provocation.', 'Imprisonment for 4 years, or fine of Rs. 2,000/-, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '336':['Doing any act which endangers human life or the personal safety of others.', 'Imprisonment for 3 months, or fine of Rs. 250/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '337':['Causing hurt by an act which endangers human life, etc.', 'Imprisonment for 6 months, or fine of Rs. 500/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '338':['Causing grievous hurt by an act which endangers human life, etc.', 'Imprisonment for 2 years, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '341':['Wrongfully restraining any person.', 'S.I for 1 month, or fine of Rs. 500/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '342':['Wrongfully confining any person.', 'Imprisonment for 1 year, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '352':['Assault or use of criminal force otherwise than on grave provocation.', 'Imprisonment for 3 months, or fine of Rs. 500/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '357':['Assault or use of criminal force in attempt wrongfully to confine a person.', 'Imprisonment for 1 year, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate'],
     '358':['Assault or use of criminal force on grave and sudden provocation.', 'S.I for 1 month, or fine of Rs. 200/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate'],
     ...
     '368':['Concealing or keeping in confinement a kidnapped person.', 'Punishment for kidnapping or abduction.', 'Cognizable', 'Non-Bailable', 'Court by which\nthe kidnapping or\nabduction is\ntriable.'],
     ...
     '405':['If by clerk or person employed by deceased', 'Imprisonment for 7 years and fine.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '427':['Mischief, and thereby causing damage to the amount of Rs. 50 or upwards.', 'Imprisonment for 2 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '428':['Mischief by killing, poisoning, maiming or rendering useless any animal of the value of Rs. 10/- or upwards.', 'Imprisonment for 2 years, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '429':['Mischief by killing, poisoning, maiming or rendering useless any elephant, camel, horse, etc., whatever may be its value, or any other animal of the value of Rs. 50/- or upwards.', 'Imprisonment for 5 years, or fine, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'], 
     ...
     '435':['Mischief by fire or explosive substance with intent to cause damage to an amount of Rs. 100/- or upwards, or, in case of agricultural produce, Rs. 10/- or upwards.', 'Imprisonment for 7 years and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '447':['Criminal trespass.', 'Imprisonment for 3 months, or fine of Rs. 500/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '448':['House-trespass.', 'Imprisonment for 1 year, or fine of Rs. 1,000/-, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '472':['Making or counterfeiting a seal, plate, etc., with intent to commit a forgery punishable under section 467 of I.P.C, or possessing with like intent any such seal, plate, etc., knowing the same to be counterfeit.', 'Imprisonment for life, or imprisonment for 7 years and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '473':['Making or counterfeiting a seal, plate, etc., with intent to commit a forgery punishable otherwise than under section 467 of I.P.C, or possessing with like intent any such seal, plate, etc., knowing the same to be counterfeit.', 'Imprisonment for 7 years and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '474':['Having possession of a document, knowing it to be forged, with intent to use it as genuine; if the document is one of the description mentioned in section 466 of I.P.C.', 'Imprisonment for 7 years and fine.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'], 
     '475':['Counterfeiting a device or mark used for authenticating documents described in section 467 of I.P.C, or possessing counterfeit marked material.', 'Imprisonment for life, or imprisonment for 7 years and fine.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '476':['Counterfeiting a device or mark used for authenticating documents other than those described in section 467 of I.P.C, or possessing counterfeit marked material.', 'Imprisonment for 7 years and fine.', 'Non-Cognizable', 'Non-Bailable', 'Magistrate of the first class.'],
     ...
     '485':['Fraudulently making or having possession of any die, plate or other instrument for counterfeiting any public or private property mark.', 'Imprisonment for 3 years, or fine, or both.', 'Non-Cognizable', 'Bailable', 'Magistrate of the first class.'],    
     ...
     '489E':['Making or using documents resembling currency-notes or bank-notes.', 'Fine of Rs. 100/-.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '490':['On refusal to disclose the name and address of the printer','Fine of Rs. 200/-','Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     
     '491':['Being bound to attend on or supply the wants of a person who is helpless from youth, unsoundness of mind or disease, and voluntarily omitting to do so.', 'Imprisonment for 3 months, or fine of Rs. 200/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '509':['Uttering any word or making any gesture intended to insult the modesty of a woman, etc.', 'S.I for 3 years and with fine.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '510':['Appearing in a public place, etc., in a state of intoxication, and causing annoyance to any person.', 'S.I for 24 hours, or fine of Rs. 10/-, or both.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     # print(l3)
     root13=Tk()
     # root13.maxsize(1000,500)
     # root13.minsize(1000,500)
     # root13.configure(bg="peach puff")
     # w=1000
     # h=500
     ws = root13.winfo_screenwidth()
     hs = root13.winfo_screenheight() 
     canvas_width=root13.winfo_screenwidth()
     canvas_height=root13.winfo_screenheight()
     # root13.geometry(f"{canvas_width}x{canvas_height}")
     # root13.resizable(False,False)
     root13.geometry("{0}x{1}+0+0".format(canvas_width,canvas_height))
     ...
     canvas1.create_line(680,80,680,canvas_height,width=3,fill="white")
     canvas1.create_line(870,80,870,canvas_height,width=3,fill="white")
     canvas1.create_line(1140,80,1140,canvas_height,width=3,fill="white")
     canvas1.create_line(100,80,100,canvas_height,width=3,fill="white")
     canvas1.create_line(440,80,440,canvas_height,width=3,fill="white")


     frame13 = Frame(canvas1, bg = 'gray30')
     ...
     # canvas1.create_line()
     Label(frame13,bg="gray30",text=" ").pack(padx=canvas_width,pady=canvas_height)
     Label(frame13,bg="gray30",text="Offence",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=210,y=95)
     Label(frame13,bg="gray30",text="Section",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=10,y=95)
     Label(frame13,bg="gray30",text="Punishment",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=490,y=95)
     Label(frame13,bg="gray30",text="Cognizable or\nnon-cognizable",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=695,y=86)
     Label(frame13,bg="gray30",text="Bailable or\nnon-bailable",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=935,y=86)
     Label(frame13,bg="gray30",text="By what Court\ntriable",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=1170,y=86)
     # Label(frame13,bg="gray30",text="Magistrate of the\n1st Class",fg="pink",font=(("Goudy old style"),15,"bold")).place(x=1148,y=176)

     Label(frame13,bg="gray30",text=n,fg="pink",font=(("Goudy old style"),15,"bold")).place(x=25,y=175)

          # canvas1.create_line(1000,30,1000,canvas_height)
     # x = (ws/2) - (w/2)
     # y = (hs/2) - (h/2)
     # frame13.maxsize(ws,hs)
     # frame13.overrideredirect(True)
     # frame13.overrideredirect(False)
     # frame13.attributes('-fullscreen',True)
     # frame13.geometry("{0}x{1}+0+0".format(frame13.winfo_screenwidth()-pad, frame13.winfo_screenheight()-pad))
     # frame13.maxsize(1000,500)
     t=l3.index(n)
     if t>=l3.index("109") and t<=l3.index("120"):
          Label(frame13,text="CHAPTER V (Sec. 109 to 120)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="ABETMENT.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t==l3.index("120B"):
          Label(frame13,text="CHAPTER V-A (Sec. 120B)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="CRIMINAL CONSPIRACY.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("121") and t<=l3.index("130"):
          Label(frame13,text="CHAPTER VI (Sec. 121 to 130)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES AGAINST THE STATE.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("131") and t<=l3.index("140"):
          Label(frame13,text="CHAPTER VII (Sec. 131 to 140)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO THE ARMY, NAVY AND AIR FORCE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("143") and t<=l3.index("160"):
          Label(frame13,text="CHAPTER VIII (Sec. 143 to 160)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES AGAINST THE PUBLIC TRANQUILLITY.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("161") and t<=l3.index("171"):
          Label(frame13,text="CHAPTER IX (Sec. 161 to 171)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES BY OR RELATING TO PUBLIC SERVANTS.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("171E") and t<=l3.index("171I"):
          Label(frame13,text="CHAPTER IX-A (Sec. 171A to 171I)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO ELECTIONS.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("172") and t<=l3.index("190"):
          Label(frame13,text="CHAPTER X (Sec. 172 to 190)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)   
          Label(frame13,text="CONTEMPTS OF THE LAWFUL AUTHORITY OF PUBLIC SERVANTS.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)   
     elif t>=l3.index("193") and t<=l3.index("229A"):
          Label(frame13,text="CHAPTER XI (Sec. 193 to 229A)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="FALSE EVIDENCE AND OFFENCES AGAINST PUBLIC JUSTICE.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("231") and t<=l3.index("263A"):
          Label(frame13,text="CHAPTER XII (Sec. 231 to 263A)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES RELATING TO COIN AND GOVERNMENT STAMPS",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("264") and t<=l3.index("267"):
          Label(frame13,text="CHAPTER XIII (Sec. 264 to 267)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES RELATING TO WEIGTHS AND MEASURES.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("269") and t<=l3.index("294A"):
          Label(frame13,text="CHAPTER XIV (Sec. 269 to 294A)",font=("Goudy old style", 15,"bold")) .place(x=550,y=0)
          Label(frame13,text="OFFENCES AFFECTING THE PUBLIC HEALTH, SAFETY, CONVENIENCE, DECENCY AND MORALS.",font=("Goudy old style", 12,"bold")) .place(x=550,y=40)
     elif t>=l3.index("295") and t<=l3.index("298"):
          Label(frame13,text="CHAPTER XV (Sec. 295 to 298)",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO RELEGION.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("302") and t<=l3.index("377"):
          Label(frame13,text="CHAPTER XVI (Sec. 302 to 377)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES AFFECTING THE HUMAN BODY.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("379") and t<=l3.index("462"):
          Label(frame13,text="CHAPTER XVII (Sec. 379 to 462)", font=("Goudy old style", 15, "bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES AGAINST PROPERTY.", font=("Goudy old style", 15, "bold")).place(x=550,y=40) 
     elif t>=l3.index("465") and t<=l3.index("490"):
          Label(frame13,text="CHAPTER XVIII (Sec. 465 to 490)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO DOCUMENTS AND TO PROPERTY MARKS.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t==l3.index("491"):
          Label(frame13,text="CHAPTER XIX (Sec. 491)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="CRIMINAL BREACH OF CONTRACTS OF SERVICE.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("493") and t<=l3.index("498"):
          Label(frame13,text="CHAPTER XX (Sec. 493 to 498)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES RELATING TO MARRAIGE.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t==l3.index("498A"):
          Label(frame13,text="CHAPTER XX-A (Sec. 498A)",font=("Goudy old style", 15,"bold")).place(x=550,y=0) 
          Label(frame13,text="OF CRUELTY BY HUSBAND OR RELATIVES OF HUSBAND.",font=("Goudy old style", 15,"bold")).place(x=550,y=40) 
     elif t>=l3.index("500") and t<=l3.index("502"):
          Label(frame13,text="CHAPTER XXI (Sec. 500 to 502)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="DEFAMATION.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t>=l3.index("504") and t<=l3.index("510"):
          Label(frame13,text="CHAPTER XXII (Sec. 504 to 510)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)   
          Label(frame13,text="CRIMINAL INTIMIDATION, INSULT AND ANNOYANCE.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)   
     elif t==l3.index("511"):
          Label(frame13,text="CHAPTER XXIII (Sec. 511)",font=("Goudy old style", 15,"bold")).place(x=550,y=0)    
          Label(frame13,text="ATTEMPTS TO COMMIT OFFENCES.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)    
     s=False    
     print()
     if n in d1.keys():
          for i,j in d1.items():
               if n==i: 
                    Label(frame13,text=j[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=175)
                    Label(frame13,text=j[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=175)
                    Label(frame13,text=j[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=175)
                    Label(frame13,text=j[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=250).place(x=880,y=175)
                    Label(frame13,text=j[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=175)
     if n in d2.keys():
          for i1,j1 in d2.items():
               if n==i1:
                    Label(frame13,text=j1[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=435)
                    Label(frame13,text=j1[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=435)
                    Label(frame13,text=j1[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=435)
                    Label(frame13,text=j1[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=250).place(x=880,y=435)
                    Label(frame13,text=j1[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=435)
     if n in d3.keys():               
          for i2,j2 in d3.items():
               if n==i2:
                    Label(frame13,text=j2[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=700)
                    Label(frame13,text=j2[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=700)
                    Label(frame13,text=j2[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=700)
                    Label(frame13,text=j2[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=700)
                    Label(frame13,text=j2[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=700)
     if n in d4.keys():
          for i2,j2 in d4.items():
               if n==i2:
                    Label(frame13,text=j2[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=965)
                    Label(frame13,text=j2[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=965)
                    Label(frame13,text=j2[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=965)
                    Label(frame13,text=j2[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=965)
                    Label(frame13,text=j2[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=965)
     if n in d5.keys():
          for i2,j2 in d5.items():
               if n==i2:
                    Label(frame13,text=j2[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=1230)
                    Label(frame13,text=j2[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=1230)
                    Label(frame13,text=j2[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=1230)
                    Label(frame13,text=j2[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=1230)
                    Label(frame13,text=j2[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=1230)
     if n in d6.keys():
          for i2,j2 in d6.items():
               if n==i2:
                    Label(frame13,text=j2[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=1495)
                    Label(frame13,text=j2[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=1495)
                    Label(frame13,text=j2[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=1495)
                    Label(frame13,text=j2[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=1495)
                    Label(frame13,text=j2[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=1495)
     root13.mainloop()
