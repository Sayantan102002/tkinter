...
if z3==0 or z3<0:
    ...
    def Probate():
        ...
        def press():
            ...
            label11.destroy()
            label12.destroy()
            label11=Label(root4,text="Court Fees to be paid of ",fg="green",font="Helvetica 13 bold",bg="SlateGray2")
            label11.place(x=375,y=365)
            label12=Label(root4,text="Rs. "+z+".0",fg="red",font="Helvetica 13 bold",bg="SlateGray2")
            label12.place(x=630,y=365)
        w=1075
        h=500
        ...
        Label(root4,text="Enter the amount",fg="black",font="Ariel 15 bold").place(x=250,y=250)
        amount=IntVar()
        entry=Entry(root4,textvariable=amount,font="Helvetica 15 bold")
        entry.place(x=525,y=250)
        Button(root4,text="Get Result",font="Helvetica 12 bold",fg="white",bg="red4",command=press).place(x=450,y=300)
        root4.mainloop()
    def Second_schedule():
        pass
    def accident():
    ...
    f.place(x=140,y=100,width=400,height=130)
    ...
    Label(f2,text="LEGAL PRACTIONERS' ASSISTANT",padx=15,fg="red",font=" Ariel 12 bold",pady=5,bg="yellow").place(x=0,y=0)
    ...
    Label(f,text="- : Developed by : -\n Advocate Suman Chakraborty\n &\n Sayantan Chakraborty\n Ph. Nos. : - 9434 450 866 / 7908 375 185",bg="pink",fg="blue2",font="Helvetica 12 bold").place(x=0,y=0)
