...
name_=Entry(root,textvariable=name,fg="DeepPink3",font=12,width=15).grid(row=2,column=4,columnspan=5,sticky=E)
phone_=Entry(root,textvariable=phone,fg="DeepPink3",font=12,width=15).grid(row=3,column=4,columnspan=5,sticky=E)
email_=Entry(root,textvariable=email,fg="DeepPink3",font=12,width=15).grid(row=4,column=4,columnspan=5,sticky=E)
gender_=Entry(root,textvariable=gender,fg="DeepPink3",font=12,width=15).grid(row=5,column=4,columnspan=5,sticky=E)
contact_=Entry(root,textvariable=contact,fg="DeepPink3",font=12,width=15).grid(row=6,column=4,columnspan=5,sticky=E)
...
payment_=Combobox(root,values=paymentmodes).grid(row=7,column=4,columnspan=5,sticky=E)
