...
class IPC:
   def check(self,n):
     ...
     '123':['If not committed.', 'Imprisonment for 6 months, or fine, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '128':['Or to go armed.', 'Imprisonment for 2 years, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '137':['Deserter concealed on board merchant vessel, through negligence of root13 or person in charge thereof.', 'Fine of 500 rupees.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '120':['Hiring, engaging or employing persons to take part in an unlawful assembly.', 'The same as for a member of such assembly, and for any offence committed by any member of such assembly.', 'Cognizable', 'According as offence is bailable or non-bailable.', 'The Court by which the offence is triable.'],
     '121':['Knowingly joining or continuing in any assembly of five or more persons after it has been commanded to disperse.', 'Imprisonment for 6 months, or fine or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '122':['Assaulting or obstructing public servant when suppressing riot, etc.', 'Imprisonment for 3 years, or fine, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     '123':['Wantonly giving provocation with intent to cause riot, if rioting be committed.', 'Imprisonment for 1 year, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     
     '123A':['Promoting enmity between classes.', 'Imprisonment for 3 years, or fine, or both.', 'Cognizable', 'Non-Bailable', 'Magistrate of the first class.'],
     
     '123AA':['Knowingly carrying arms in any procession or organising or holding or taking part in any mass drill or mass traning with arms.', 'Imprisonment for 6 months and kfine of 2,000 rupees.', 'Cognizable', 'Non-Bailable', 'Any Magistrate.', 'Ins. by Cr.P.C (Amendment) Act 2005 (25 of 2005)'],
     '123B':['Imputations, assertions prejudicial to national integration', 'Imprisonment for 3 years, or fine, or both.', 'Cognizable', 'Non-Bailable', 'Magistrate of the first class.'],
     '124':['Owner or occupier of land not giving information of riot, etc.', 'Fine of 1,000 rupees.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '125':['Person for whose benefit or on whose behalf a riot takes place not using all lawful means to prevent it.', 'Fine.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '126':['Agent of owner or occupier for whose benefit a riot is committed not using all lawful means to prevent it.', 'Fine.', 'Non-Cognizable', 'Bailable', 'Any Magistrate.'],
     '127':['Harbouring persons hired for an unlawful assembly.', 'Imprisonment for 6 months, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     '128':['Being hired to take part in an unlawful assembly or riot.', 'Imprisonment for 6 months, or fine, or both.', 'Cognizable', 'Bailable', 'Any Magistrate.'],
     ...
     '212':['Taking gift to help to recover movable property of which a person has been deprived by an offence without causing apprehension of offender.', 'Imprisonment for 2 years, or fine, or both.', 'Cognizable', 'Bailable', 'Magistrate of the first class.'],
     ...
     '312':['Act done with intent to prevent a child being born alive, or to cause it to die after its birth.', 'Imprisonment for 10 years, or fine, or both.', 'Cognizable', 'Non-Bailable', 'Court of Session.'],
     ...
     '381':['Theft by clerk or servant of property in possession of root13 or employer.', 'Imprisonment for 7 years and fine.', 'Cognizable', 'Non-Bailable', 'Any Magistrate.'],
    ...
    #  frame13.place(x=0,y=0,width=canvas_width,height=canvas_height)
     ...
     if t>=l3.index("109") and t<=l3.index("120"):
          Label(frame13,text="CHAPTER V",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="ABETMENT.",font=("Goudy old style", 15,"bold")).place(x=550,y=40)
     elif t==l3.index("120B"):
          Label(frame13,text="CHAPTER V-A",font=("Goudy old style", 15,"bold")).place(x=550,y=0)
          Label(frame13,text="CRIMINAL CONSPIRACY.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("121") and t<=l3.index("130"):
          Label(frame13,text="CHAPTER VI",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCE AGAINST THE STATE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("131") and t<=l3.index("140"):
          Label(frame13,text="CHAPTER VII",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCE RELATING TO THE ARMY, NAVY AND AIR FORCE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("143") and t<=l3.index("160"):
          Label(frame13,text="CHAPTER VIII",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCE AGAINST THE PUBLIC TRANQUILLITY.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("161") and t<=l3.index("171"):
          Label(frame13,text="CHAPTER IX",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCE BY OR RELATING TO PUBLIC SERVANTS.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("171E") and t<=l3.index("171I"):
          Label(frame13,text="CHAPTER IX-A",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO ELECTIONS.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("172") and t<=l3.index("190"):
          Label(frame13,text="CHAPTER X",font=("Goudy old style", 12,"bold")).place(x=550,y=0)   
          Label(frame13,text="CONTEMPTS OF THE LAWFUL AUTHORITY OF PUBLIC SERVANTS.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)   
     elif t>=l3.index("193") and t<=l3.index("229A"):
          Label(frame13,text="CHAPTER XI",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="FALSE EVIDENCE AND OFFENCES AGAINST PUBLIC JUSTICE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t>=l3.index("231") and t<=l3.index("263A"):
          Label(frame13,text="CHAPTER XII",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
     elif t>=l3.index("264") and t<=l3.index("267"):
          Label(frame13,text="CHAPTER XIII",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCE RELATING TO WEIGTHS AND MEASURES.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t>=l3.index("269") and t<=l3.index("294A"):
          Label(frame13,text="CHAPTER XIV",font=("Goudy old style", 12,"bold")) .place(x=550,y=0)
          ...
          Label(frame13,text="CHAPTER XV",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          ...
          Label(frame13,text="CHAPTER XVI",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES AFFECTING THE HUMAN BODY.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t>=l3.index("379") and t<=l3.index("462"):
          Label(frame13,text="CHAPTER XVII").place(x=550,y=0) 
          Label(frame13,text="OFFENCES AGAINST PROPERTY.").place(x=550,y=40) 
     elif t>=l3.index("465") and t<=l3.index("490"):
          Label(frame13,text="CHAPTER XVIII",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="OFFENCES RELATING TO DOCUMENTS AND TO PROPERTY MARKS.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t==l3.index("491"):
          Label(frame13,text="CHAPTER XIX",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="CRIMINAL BREACH OF CONTRACTS AND SERVICE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t>=l3.index("493") and t<=l3.index("498"):
          Label(frame13,text="CHAPTER XX",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="OFFENCES RELATING TO MARRAIGE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t==l3.index("498A"):
          Label(frame13,text="CHAPTER XX-A",font=("Goudy old style", 12,"bold")).place(x=550,y=0) 
          Label(frame13,text="OF CRUELTY BY HUSBAND OR RELATIVES OF HUSBAND.",font=("Goudy old style", 12,"bold")).place(x=550,y=40) 
     elif t>=l3.index("500") and t<=l3.index("502"):
          Label(frame13,text="CHAPTER XXI",font=("Goudy old style", 12,"bold")).place(x=550,y=0)
          Label(frame13,text="DEFAMATION.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)
     elif t>=l3.index("504") and t<=l3.index("510"):
          Label(frame13,text="CHAPTER XXII",font=("Goudy old style", 12,"bold")).place(x=550,y=0)   
          Label(frame13,text="CRIMINAL INTIMIDATION, INSULT AND ANNOYANCE.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)   
     elif t==l3.index("511"):
          Label(frame13,text="CHAPTER XXIII",font=("Goudy old style", 12,"bold")).place(x=550,y=0)    
          Label(frame13,text="ATTEMPTS TO COMMIT OFFENCES.",font=("Goudy old style", 12,"bold")).place(x=550,y=40)    
     s=False    
     print()
     if n in d1.keys():
          for i,j in d1.items():
               if n==i: 
                    ...
                    Label(frame13,text=j[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=175)
          ...
          for i1,j1 in d2.items():
               if n==i1:
                    Label(frame13,text=j1[0],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300,justify=CENTER).place(x=120,y=900)
                    Label(frame13,text=j1[1],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=220,justify=LEFT).place(x=450,y=375)
                    Label(frame13,text=j1[2],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=690,y=375)
                    Label(frame13,text=j1[3],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=300).place(x=880,y=375)
                    Label(frame13,text=j1[4],font=("Goudy old style", 15,"bold"),fg="yellow",bg="gray30",wraplengt=180,justify=LEFT).place(x=1150,y=375)
